...
const ResultPeter = ({ answers, category }) => {
  ...
  useEffect(() => {
    ...
    } else if (activeCount === reflectiveCount) {
      learningStyle = "ACTIVO Y REFLEXIVO";
    } else if (activeCount === theoreticalCount) {
      learningStyle = "ACTIVO Y TEÓRICO";
    } else if (activeCount === pragmaticCount) {
      learningStyle = "ACTIVO Y PRAGMÁTICO";
    } else if (reflectiveCount === theoreticalCount) {
      learningStyle = "REFLEXIVO Y TEÓRICO";
    } else if (reflectiveCount === pragmaticCount) {
      learningStyle = "REFLEXIVO Y PRAGMÁTICO";
    } else if (theoreticalCount === pragmaticCount) {
